# MODIFIED FROM https://github.com/yilundu/generals_a3c
import argparse
...
if __name__ == "__main__":
    ...
    with open("/Volumes/My Passport for Mac/generals_project/data_x.pkl", "wb") as f:
        pkl.dump(x, f)

    with open("/Volumes/My Passport for Mac/generals_project/data_y.pkl", "wb") as f:
        pkl.dump(y, f)

    with open("/Volumes/My Passport for Mac/generals_project/data_z.pkl", "wb") as f:
        pkl.dump(z, f)
